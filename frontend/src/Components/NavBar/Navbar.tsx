...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="select-none sticky top-0 z-50 bg-white h-20 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
      ...
      <div className="hidden md:flex justify-center items-center h-full gap-8">
        ...
        <div className="w-1/3 xl:w-1/2 flex items-center gap-12 ">
          ...
          <div className="hidden xl:flex gap-4">
            ...
            <Link to={"/company/search"}>Project-App</Link>
...
//   return (
//     <div className="select-none h-20 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative">
//       <div className="flex items-center justify-between md:hidden">
//         {/* MOBILE */}
//         <Link to={"/"}>
//           <div className="text-2xl tracking-wide">Richard</div>
